                                ...
                                <tbody>
                                    <tr class="text-left" v-for ="client in clients">
                                      ...
                                      <td>
                                          ...
                                          <button class="btn btn-success"  @click="showClientDetailModal=true"><i class="fs bi-eye"></i></button>
    ...
    <div id="overlay" v-if= "showDeleteModal">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Voulez vous vraiment supprimer "{{currentClient.prenomClient}} {{currentClient.nomClient}}"?</p>
            </div>
            <div class="modal-footer">
